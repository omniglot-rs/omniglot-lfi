...
pub fn criterion_benchmark(c: &mut Criterion) {
    ...
    let og_lfi_executable = build_bench_executable("process_startup_demo_nop_og_lfi");
    ...
    group.bench_function("og_lfi", |b| {
        b.iter(|| Command::new(&og_lfi_executable).output().unwrap());
    });
